...
/**
 * The Plant class represents a plant with its details.
 */
class Plant {
    private String name;
    ...
    public String toString() {
        return "Plant{name='" + this.name + "', species='" + this.species + "', age=" + this.age + " years, careInstructions='" + this.careInstructions + "'}";
    }
}
